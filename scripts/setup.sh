...
echo "# HiveChat Configuration" > .env
...
echo "# ============================================================" >> .env
echo "" >> .env
echo "POSTGRES_USER=hivechat" >> .env
echo "POSTGRES_PASSWORD=${POSTGRES_PASSWORD}" >> .env
echo "POSTGRES_DB=hivechat" >> .env
echo "DATABASE_URL=postgresql://hivechat:${POSTGRES_PASSWORD}@db:5432/hivechat" >> .env
echo "" >> .env
echo "# ============================================================" >> .env
